...
int main()
{
    ...
    printf("Welcome to data structure Application written by Vaibhav \n");
    ...
    while(1)
    {
        ...
        printf("3 : Insert new node at given at position\n");
        printf("4 : Delete new node at first position\n");
        printf("5 : Delete new node at last position\n");
        printf("6 : Delete new node at given at position\n");

        printf("7 : Display the conntent of linked list\n");
        printf("6 : Count the number of nodes from linked list \n");
